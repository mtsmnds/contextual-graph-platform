...
- **prd0035b** - double-click pane to create node at click position + fix node positioning for button (ADR: archive/m4/m4-prd0035b-pane-double-click-position-fix.md)
